  ...
  return (
    <button
      ...
      className={clsx(
        ...
        !isSelected && !isReview && 'border-slate-200 bg-white',
        correct && 'border-green-500 bg-green-50',
        wrong   && 'border-red-400 bg-red-50',
        isReview && !correct && !wrong && 'border-slate-200 bg-white opacity-60',
      )}
    >
      ...
      <div className={clsx(
        ...
        !isSelected && !isReview && 'border-slate-300 text-slate-400',
        correct && 'border-green-500 bg-green-500 text-white',
        wrong   && 'border-red-400 bg-red-400 text-white',
        isReview && !correct && !wrong && 'border-slate-300 text-slate-400',
      )}>
        {isReview
      ...
      <span className={clsx(
        ...
        !isSelected && !isReview && 'text-slate-700',
        correct && 'text-green-800',
        wrong   && 'text-red-700',
        isReview && !correct && !wrong && 'text-slate-500',
      )}>
        {option.option_text}
      </span>
    </button>
